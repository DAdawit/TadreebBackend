...
export interface ApiCourseCourse extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    training_category: Attribute.Relation<
      'api::course.course',
      'manyToOne',
...
export interface ApiTrainingTraining extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    slug: Attribute.UID<'api::training.training', 'title'>;
    training_categories: Attribute.Relation<
      'api::training.training',
      'manyToMany',
      'api::training-category.training-category'
    >;
...
export interface ApiTrainingCategoryTrainingCategory
  extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    slug: Attribute.UID<'api::training-category.training-category', 'title'>;
    trainings: Attribute.Relation<
      'api::training-category.training-category',
      'manyToMany',
      'api::training.training'
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::training-category.training-category': ApiTrainingCategoryTrainingCategory;
